...
// Data planet
const planetData = [
    { name: "Mercury", radius: 3.2, texture: 'assets/textures/mercury.jpg', spinRadius : 320, rotateSpeed: 0.2, currentAngle: 0 },
    { name: "Venus", radius: 4.8, texture: 'assets/textures/venus.jpg', spinRadius : 360, rotateSpeed: 0.15, currentAngle: 0  },
    { name: "Earth", radius: 4.8, texture: 'assets/textures/earth.jpg', spinRadius : 400, rotateSpeed: 0.10, currentAngle: 0  },
    { name: "Mars", radius: 4, texture: 'assets/textures/mars.jpg', spinRadius : 465, rotateSpeed: 0.05, currentAngle: 0  },
    { name: "Jupiter", radius: 13, texture: 'assets/textures/jupiter.jpg', spinRadius : 510, rotateSpeed: 0.025, currentAngle: 0  },
    { name: "Saturn", radius: 10,  texture: 'assets/textures/saturn.jpg', spinRadius : 560, rotateSpeed: 0.015, currentAngle: 0  },
    { name: "Uranus", radius: 8,  texture: 'assets/textures/uranus.jpg', spinRadius : 615, rotateSpeed: 0.005, currentAngle: 0  },
    { name: "Neptune", radius: 6,  texture: 'assets/textures/neptune.jpg', spinRadius : 655, rotateSpeed: 0.001 , currentAngle: 0 },
];
